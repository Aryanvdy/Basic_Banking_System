...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr >
                        <td class="py-2" align="center" ><?php echo $rows['id'] ?></td>
                        <td class="py-2" align="center" ><?php echo $rows['name']?></td>
                        <td class="py-2" align="center" ><?php echo $rows['email']?></td>
                        <td class="py-2" align="center" ><?php echo $rows['balance']?></td>
                        <td align="center">
